...
import { Leaf, Sprout, Cloud, ChartAreaIcon, Brain, Package } from "lucide-react";
        ...
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center p-3 rounded-lg transition-all duration-200 ${isActive
                  ...
                  : "text-gray-700 hover:bg-mycol-nyanza/50 hover:text-mycol-brunswick_green"
                }`
              }
            >
              <Sprout className="w-5 h-5 mr-3" />
              <span className="font-medium">Crop Suggestion</span>
            </NavLink>
            ...
            >
              ...
              <span className="font-medium">Fertilizer Suggestion</span>
            </NavLink>
            <NavLink
