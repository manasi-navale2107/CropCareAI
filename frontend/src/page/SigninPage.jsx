    ...
    <div className="min-h-screen bg-gradient-to-br from-mycol-nyanza via-white to-mycol-celadon-2 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-5 transition-colors duration-200">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-mycol-brunswick_green dark:text-gray-100 mb-3">
            Welcome Back to CropCare AI
          </h1>
          <p className="text-mycol-sea_green dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Access your crop insurance dashboard and manage your policies
          </p>
        </div>

        {/* Main Content */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/50 overflow-hidden border border-transparent dark:border-gray-700 transition-colors duration-200">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 p-8">
            {/* Left Side - Information */}
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-mycol-nyanza/50 dark:bg-gray-700/50 p-6 rounded-xl transition-colors duration-200">
                <h3 className="text-xl font-semibold text-mycol-brunswick_green dark:text-gray-200 mb-4">
                  Quick Access To
                </h3>
              ...
              <div className="bg-mycol-nyanza/50 dark:bg-gray-700/50 p-6 rounded-xl transition-colors duration-200">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-mycol-sea_green dark:text-gray-200">24/7 Support</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Our team is always here to help</p>
                    </div>
                  </div>
                  <Link
                    to="/forgetpassword"
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-semibold text-mycol-sea_green dark:text-gray-200 group-hover:text-mycol-mint transition-colors">
                        Forgot Password?
                      </h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Reset it securely</p>
                    </div>
                  </Link>
                </div>
              </div>
            ...
            <div className="lg:col-span-3">
              <div className="max-w-md mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Login Form Section */}
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg space-y-4 transition-colors duration-200">
                    {/* Email/Phone Input */}
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="w-full pl-10 pr-4 py-3 rounded-lg font-medium bg-white text-gray-900 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-mycol-mint focus:border-transparent transition-all duration-300"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="w-full pl-10 pr-10 py-3 rounded-lg font-medium bg-white text-gray-900 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-mycol-mint focus:border-transparent transition-all duration-300"
