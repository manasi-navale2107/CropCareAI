      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-mycol-brunswick_green dark:text-gray-100 mb-3">
            Join CropCare AI Today
          </h1>
          <p className="text-mycol-sea_green dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Protect your crops with India's most trusted smart agriculture platform
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/50 overflow-hidden border border-transparent dark:border-gray-700 transition-colors duration-200">
          ...
          <div className="bg-mycol-nyanza dark:bg-gray-800 p-4 border-b border-mycol-celadon dark:border-gray-700 transition-colors duration-200">
              ...
              <div className="bg-mycol-nyanza/50 dark:bg-gray-700/50 p-6 rounded-xl transition-colors duration-200">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-600">Instant AI crop analysis</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="w-5 h-5 text-mycol-mint mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">24/7 expert recommendations</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="w-5 h-5 text-mycol-mint mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              ...
              <div className="bg-mycol-nyanza/50 dark:bg-gray-700/50 p-6 rounded-xl transition-colors duration-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-mycol-sea_green">Precision Farming</h4>
                      <p className="text-sm text-gray-600">Data-driven crop strategies</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-3">
                ...
                <AnimatePresence mode="wait">
                  {currentStep === 1 && (
                    ...
                    >
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg transition-colors duration-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-mycol-mint bg-white text-gray-900"
                          ...
                          <div className="md:col-span-1">
                            <select
                              ...
                              value={formData.role}
                              onChange={handleChange}
                              className="w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-mycol-mint bg-white text-gray-900"
                            >
              ...
              {loginError && (
                <div className="mt-4 p-4 bg-red-100 text-red-700 rounded-lg flex items-center">
                  ...
                  <span>{typeof loginError === 'string' ? loginError : "Something went wrong. Please try again."}</span>
                </div>
              )}
            </div>
          </div>
