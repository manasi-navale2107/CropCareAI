...
const HomePage = () => {
  const features = [
    ...
    },
    {
      ...
      link: "/features/crop-recommendation"
    },
    {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Get AI-powered crop and fertilizer suggestions",
      icon: "💡",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50/50 to-white dark:from-[#0f172a] dark:to-[#1e293b] overflow-x-hidden transition-colors duration-200">
      {/* Hero Section */}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <p className="text-lg mb-8 text-emerald-100 max-w-2xl">
                Transform your farming with advanced AI-powered agricultural insights.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link to="/signup" className="flex-1 sm:flex-none">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full sm:w-auto bg-white text-emerald-800 px-8 py-4 rounded-xl font-semibold hover:bg-emerald-50 transition-all shadow-lg"
                  >
                    Get Started Free
                  </motion.button>
                </Link>
            ...
            {features.map((feature, index) => (
              <Link to={feature.link} key={index}>
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  viewport={{ once: true }}
                  className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl dark:shadow-gray-900/50 transition-all border border-transparent hover:border-emerald-500/50 dark:border-gray-700 h-full cursor-pointer"
                >
                  <div
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-[#1e293b] dark:to-[#0f172a] py-24 transition-colors duration-200">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
            ...
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg dark:shadow-gray-900/50 text-center z-10 border border-transparent dark:border-gray-700 transition-colors duration-200"
              >
      ...
      {/* CTA Section */}
      <section className="py-24 bg-[url('/pattern.svg')] dark:bg-[url('/pattern-dark.svg')] bg-cover transition-colors duration-200">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-12 rounded-3xl shadow-xl dark:shadow-gray-900/50 border border-transparent dark:border-gray-700">
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">
              Start Your Smart Farming Journey Today
            </h2>
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              Join 50,000+ farmers already optimizing their crop yields with AI
            </p>
            <Link to="/signup">
              <motion.button
                whileHover={{ scale: 1.05 }}
      ...
      {/* <footer className="bg-gradient-to-b from-emerald-800 to-emerald-900 text-white">
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-white/10 pb-12">
            <div>
              <h4 className="text-lg font-semibold mb-4">CropCare AI</h4>
