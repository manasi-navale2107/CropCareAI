  ...
  const features = [
    {
      ...
      description: "Personalized crop suggestions, fertilizer advice, and disease detection.",
      icon: <IconAi size={40} className="text-green-500" />,
    },
    {
      title: "Data Security",
      description: "Secure and private storage of all your farm data.",
      icon: <IconCloud size={40} className="text-yellow-500" />,
    },
    {
