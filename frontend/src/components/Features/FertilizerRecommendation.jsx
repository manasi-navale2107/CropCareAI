    ...
    >
        ...
        <div className="relative">
            <input
                ...
                value={value}
                onChange={onChange}
                className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white text-black"
                required
            />
...
const FertilizerRecommendation = () => {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="bg-gradient-to-r from-mycol-brunswick_green to-mycol-sea_green py-12 px-4 shadow-lg mb-8">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl font-bold text-white mb-4">
                        Fertilizer Suggestion
                    </h1>
                    <p className="text-mycol-nyanza text-lg">
                        Enter your field parameters to get personalized fertilizer suggestions
                    </p>
                </div>
            </div>
            {prediction.prediction ? (
                <div ref={resultsRef} className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-mycol-brunswick_green mb-6 transform transition-all hover:scale-[1.02]">
                                <h3 className="text-xl text-gray-800 mb-2">
                                    Suggested Fertilizer:{" "}
                                    <span className="font-bold text-2xl text-mycol-brunswick_green capitalize">{prediction.prediction}</span>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-6 border-b border-gray-100">
                                ...
                                <div className="mt-8 border-t border-gray-200 pt-6">
                                    <h3 className="text-xl font-semibold text-mycol-brunswick_green mb-4 flex items-center">
                                        Products available for your suggested fertilizer
                                    </h3>
                                </div>
                            </div>
                            <div className="p-6">
