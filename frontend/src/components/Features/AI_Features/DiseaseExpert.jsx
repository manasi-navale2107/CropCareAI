        ...
        return (
            <div className="space-y-6">
                ...
                {content.productRecommendations && content.productRecommendations.length > 0 && (
                    <div className="bg-mycol-nyanza/30 p-4 rounded-xl shadow-sm border border-mycol-mint/20 mb-6">
                        <h3 className="font-semibold text-mycol-brunswick_green mb-3">Product Suggestions</h3>
            ...
            <div className="flex-1 flex flex-col max-w-7xl mx-auto w-full relative"> {/* Added relative */}
                ...
                >
                    <input
                        ...
                        className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-mycol-mint focus:border-transparent outline-none bg-white text-black"
                    />
                    <motion.button
