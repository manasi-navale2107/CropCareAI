      ...
      <div className="flex-1 flex flex-col max-w-7xl mx-auto w-full relative">
        ...
        >
          <input
            ...
            value={inputMessage}
            onChange={(e) => setInputMessage(e.target.value)}
            className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-mycol-mint focus:border-transparent outline-none bg-white text-black placeholder-gray-400"
          />
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
