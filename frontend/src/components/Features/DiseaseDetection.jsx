    ...
    const handleSubmit = async () => {
        ...
        try
        {
            ...
            if (response.data.predictions && response.data.predictions.length > 0) {
                ...
                setPrediction(null);
                setError("No crop disease could be clearly identified. Please try a clearer picture.");
            }
        } catch (error)
        {
                                ...
                                {prediction.info ? (
                                    ...
                                    <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                        <p className="text-yellow-800">
                                            Detailed care information is not available for this specific disease in our database yet.
                                        </p>
                                    </div>
                                )}
                            </div>
