            ...
            <div className="bg-gradient-to-r from-mycol-brunswick_green to-mycol-sea_green py-12 px-4 shadow-lg mb-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-mycol-nyanza text-lg">
                        Enter your soil parameters to get personalized crop suggestions
                    </p>
                </div>
            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white text-black"
                            ...
                            <div className="p-6 border-b border-gray-100">
                                ...
                                <div className="mt-8 border-t border-gray-200 pt-6">
                                    <h3 className="text-xl font-semibold text-mycol-brunswick_green mb-4 flex items-center">
                                        Products available for your suggested crop
                                    </h3>
                                </div>
                            </div>
                            <div className="p-6">
